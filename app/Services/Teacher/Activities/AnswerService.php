...
class AnswerService
{
    ...
    public function insertAnswer(array $request, $questionId)
    {
        ...
        {
            if ($validationResult = $this->ensureQuestionOwnership($questionId, $this->teacherId))
    ...
    public function updateAnswer($id, array $request)
    {
        return $this->executeTransaction(function () use ($id, $request)
        {
            ...
            if ($validationResult = $this->ensureQuestionOwnership($answer->question_id, $this->teacherId))
                return $validationResult;
