...
use App\Services\Admin\Users\AssistantService;
...
class AssistantsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.users.assistants.manage.index', compact('teachers', 'pageStatistics'));
    }
    ...
    public function archived(Request $request)
    {
        ...
        return view('admin.users.assistants.archive.index');
    }
