                ...
                <div class="card-body">
                        ...
                        <div class="d-flex align-items-center flex-column">
                            <div class="button-wrapper">
                                <form id="update-profile-form"
                                    action="{{ route('admin.assistants.updateProfilePic', $assistant->id) }}" method="POST"
                            ...
                            <img class="img-fluid rounded-3 mb-4"
                                src="{{ asset($assistant->profile_pic ? 'storage/profiles/assistants/' . $assistant->profile_pic : 'assets/img/avatars/default.jpg') }}"
                                height="120" width="120" alt="Profile Picture" id="uploadedAvatar" />
                            <div class="user-info text-center">
                                <h5>{{ $assistant->name }}</h5>
                                <span class="badge bg-label-{{ $assistant->is_active ? 'success' : 'secondary' }} rounded-pill">
                                    {{ trans('main.' . ($assistant->is_active ? 'active' : 'inactive')) }}
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-around flex-wrap my-6 gap-0 gap-md-3 gap-lg-4">
                        <div class="d-flex align-items-center me-5 gap-4">
                            ...
                            <div>
                                <h5 class="mb-0">{{ $assistant->teacher->assistants()->count() }}</h5>
                    ...
                    <ul class="list-unstyled my-3 py-1">
                        <li class="d-flex align-items-center mb-4">
                            ...
                            <span>{{ $assistant->getTranslation('name', 'ar') }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-4">
                            <i class="ri-user-3-line ri-24px"></i>
                            <span class="fw-medium mx-2">{{ trans('main.realName_en') }}:</span>
                            <span>{{ $assistant->getTranslation('name', 'en') }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-4">
                    ...
                    <ul class="list-unstyled my-3 py-1">
                        <li class="d-flex align-items-center mb-4">
                            ...
                            <span class="fw-medium mx-2">{{ trans('main.teacher') }}:</span>
                            <span><a target="_blank"
                                href="{{ route('admin.teachers.details', $assistant->teacher_id) }}">{{ $assistant->teacher->name }}</a></span>
                        </li>
                    </ul>
                </div>
            </div>
