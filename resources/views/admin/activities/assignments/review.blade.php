...
@section('content')
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="files-tab" role="tabpanel">
                                                ...
                                                @forelse($reviewData['files'] as $file)
                                                    <div class="d-flex align-items-center mb-4">
                                                        ...
                                                        <span class="text-nowrap overflow-hidden text-truncate"
                                                            ...
                                                            <a target="_blank"
                                                                href="{{ route('admin.assignments.submissions.download', $file->id) }}"
                                                        ...
                                                        <div class="ms-auto">
                                                            <a href="{{ route('admin.assignments.submissions.view', $file->id) }}"
                                                                target="_blank"
                                                            ...
                                                            <a href="{{ route('admin.assignments.submissions.download', $file->id) }}"
                                ...
                                <form id="feedback-form"
                                    action="{{ route('admin.assignments.feedback', ['id' => $assignment->id, 'studentId' => $student->id]) }}"
    ...
    <x-modal modalType="delete" modalTitle="{{ trans('admin/assignments.resetStudentAssignment') }}"
        action="{{ route('admin.assignments.resetStudentAssignment', ['id' => $assignment->id, 'studentId' => $student->id]) }}" submitColor="danger" submitButton="{{ trans('main.submit') }}">
...
@section('page-js')
    <script>
        ...
        handleDeletionFormSubmit('#delete-form', '#delete-modal', '#datatable', '{{ route("admin.assignments.reports", $assignment->id) }}')
    </script>
@endsection
