...
@section('content')
    ...
    <x-datatable datatableTitle="{{ trans('main.datatableTitle2', ['item' => trans('admin/teachers.teachers')]) }}"
    ...
    @include('admin.users.teachers.archive.modals')
    <!--/ DataTable with Buttons -->
@endsection

@section('page-js')
    <script>
        initializeDataTable('#datatable', "{{ route('admin.teachers.archived') }}", [2, 3, 4, 5],
            [{
                    data: "",
                    orderable: false,
                    searchable: false
