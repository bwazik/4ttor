...
@section('content')
<form id="add-form" action="{{ route('admin.invoices.insert') }}" method="POST" autocomplete="off">
    @csrf
        ...
        <div class="col-lg-3 col-12 invoice-actions">
            <div class="card mb-6">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.invoices.index') }}" id="show" class="btn btn-outline-secondary d-grid w-100 mb-4">
...
@section('page-js')
    <script>
        ...
        fetchMultipleDataByAjax('#add-form #student_id', "{{ route('admin.fetch.students.student-fees', '__ID__') }}",
            '#add-form #student_fee_id', 'student_id', 'GET');
        fetchSingleDataByAjax('#add-form #student_id', "{{ route('admin.fetch.students.data', '__ID__') }}", [
        ...
        fetchSingleDataByAjax('#add-form #student_fee_id', "{{ route('admin.fetch.student-fees.data', '__ID__') }}", [
