<!-- Add Offcanvas -->
<x-offcanvas offcanvasType="add" offcanvasTitle="{{ trans('main.addItem', ['item' => trans('admin/receipts.receipt')]) }}" action="{{ route('admin.receipts.students.insert') }}">
...
<!-- Edit Offcanvas -->
<x-offcanvas offcanvasType="edit" offcanvasTitle="{{ trans('main.editItem', ['item' => trans('admin/receipts.receipt')]) }}" action="{{ route('admin.receipts.students.update') }}" id>
...
<x-modal modalType="delete" modalTitle="{{ trans('main.deleteItem', ['item' => trans('admin/receipts.receipt')]) }}"
    action="{{ route('admin.receipts.students.delete') }}" id submitColor="danger" submitButton="{{ trans('main.yes_delete') }}">
