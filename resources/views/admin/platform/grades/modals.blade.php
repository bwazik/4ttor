...
<x-offcanvas offcanvasType="add" offcanvasTitle="{{ trans('main.addItem', ['item' => trans('admin/grades.grade')]) }}" action="{{ route('admin.grades.insert') }}">
    <x-basic-input context="offcanvas" type="text" name="name_ar" label="{{ trans('main.name_ar') }}" placeholder="{{ trans('admin/grades.placeholders.name_ar') }}" required/>
    <x-basic-input context="offcanvas" type="text" name="name_en" label="{{ trans('main.name_en') }}" placeholder="{{ trans('admin/grades.placeholders.name_en') }}" required/>
    ...
    <x-select-input context="offcanvas" name="stage_id" label="{{ trans('admin/stages.stage') }}" :options="$stages" required/>
</x-offcanvas>
<!-- Edit Modal -->
