<!-- Add Modal -->
<x-offcanvas offcanvasType="add" offcanvasTitle="{{ trans('main.addItem', ['item' => trans('admin/resources.resource')]) }}" action="{{ route('admin.resources.insert') }}">
...
<!-- Edit Modal -->
<x-offcanvas offcanvasType="edit" offcanvasTitle="{{ trans('main.editItem', ['item' => trans('admin/resources.resource')]) }}" action="{{ route('admin.resources.update') }}" id>
    <x-basic-input context="offcanvas" type="text" name="title_ar" label="{{ trans('main.title_ar') }}" placeholder="{{ trans('admin/resources.placeholders.title_ar') }}" required/>
    <x-basic-input context="offcanvas" type="text" name="title_en" label="{{ trans('main.title_en') }}" placeholder="{{ trans('admin/resources.placeholders.title_en') }}" required/>
    <x-select-input context="offcanvas" name="teacher_id" label="{{ trans('main.teacher') }}" :options="$teachers" required/>
...
<x-modal modalType="delete" modalTitle="{{ trans('main.deleteItem', ['item' => trans('admin/resources.resource')]) }}"
    action="{{ route('admin.resources.delete') }}" id submitColor="danger" submitButton="{{ trans('main.yes_delete') }}">
