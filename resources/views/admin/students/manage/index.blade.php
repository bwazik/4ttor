...
@section('content')
    ...
    <x-datatable datatableTitle="{{ trans('main.datatableTitle', ['item' => trans('admin/students.students')]) }}"
        dataToggle="offcanvas" deleteButton archiveButton addButton="{{ trans('main.addItem', ['item' => trans('admin/students.student')]) }}">
        <th></th>
...
@section('page-js')
    <script>
        ...
        $('#add-form #name_en').on('input', function() {
            const username = '4ttor' + generateRandomString() + 's';
