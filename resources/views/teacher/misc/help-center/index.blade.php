                                ...
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        ...
                                        <a class="btn btn-outline-primary"
                                            href="{{ route('teacher.help-center.show', [$article->category->slug, $article->slug]) }}">{{ trans('admin/helpCenter.readMore') }}</a>
                                    </div>
                                </div>
                            </div>
                        @empty
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled my-6">
                                            @forelse ($category->articles->take(6) as $article)
                                                <li class="mb-2">
                                                    <a href="{{ route('teacher.help-center.show', [$category->slug, $article->slug]) }}"
                                        ...
                                        @if ($category->articles->isNotEmpty())
                                            <p class="mb-0 fw-medium mt-6">
                                                <a href="{{ route('teacher.help-center.show', [$category->slug, $category->articles->sortByDesc('published_at')->first()->slug]) }}"
