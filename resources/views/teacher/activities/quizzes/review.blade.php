...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card mb-6">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="card-title m-0 me-2">{{ $quiz->name }} - {{ $student->name }}</h5>
    ...
    <x-modal modalType="delete" modalTitle="{{ trans('admin/quizzes.resetStudentQuiz') }}"
        action="{{ route('teacher.quizzes.resetStudentQuiz', ['uuid' => $quiz->uuid, 'studentUuid' => $student->uuid]) }}" submitColor="danger" submitButton="{{ trans('main.submit') }}">
...
@section('page-js')
    <script>
        ...
        handleDeletionFormSubmit('#delete-form', '#delete-modal', '#datatable', '{{ route("teacher.quizzes.reports", $quiz->uuid) }}')
    </script>
@endsection
