                        ...
                        <div class="col-md-4">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <a class="btn btn-outline-primary" href="help-center-article.html">Read More</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial bg-label-primary rounded-3"><i
                                                    class="tf-icons ri-shopping-cart-line ri-20px"></i></span>
                                        </div>
                                    ...
                                    <ul class="list-unstyled my-6">
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> How do i add or change my details?
                                                </span>
                                                <i
                                                    class="tf-icons ri-arrow-right-s-line ri-20px scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        ...
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> I'm trying to find a specific item
                                                </span>
                                                <i
                                                    class="tf-icons ri-arrow-right-s-line ri-20px scaleX-n1-rtl text-muted"></i>
                                            </a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial bg-label-primary rounded-3"><i
                                                    class="tf-icons ri-question-line ri-20px"></i></span>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial bg-label-primary rounded-3"><i
                                                    class="tf-icons ri-file-text-line ri-20px"></i></span>
                                        </div>
                                    ...
                                    <ul class="list-unstyled my-6">
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> How do licenses work for any plugins
                                                </span>
                                                <i
                                                    class="tf-icons ri-arrow-right-s-line ri-20px scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        ...
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> I want to make multiple end products
                                                </span>
                                                <i
                                                    class="tf-icons ri-arrow-right-s-line ri-20px scaleX-n1-rtl text-muted"></i>
                                            </a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial bg-label-primary rounded-3"><i
                                                    class="tf-icons ri-palette-line ri-20px"></i></span>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial bg-label-primary rounded-3"><i
                                                    class="tf-icons ri-lock-line ri-20px"></i></span>
                                        </div>
                                    ...
                                    <ul class="list-unstyled my-6">
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> I'm not receiving the verification email
                                                </span>
                                                <i
                                                    class="tf-icons ri-arrow-right-s-line ri-20px scaleX-n1-rtl text-muted"></i>
                                            </a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                                            <span class="avatar-initial bg-label-primary rounded-3"><i
                                                    class="tf-icons ri-user-line ri-20px"></i></span>
                                        </div>
                                    ...
                                    <ul class="list-unstyled my-6">
                                        ...
                                        <li class="mb-2">
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> How can I regain access to my account?
                                                </span>
                                                <i
                                                    class="tf-icons ri-arrow-right-s-line ri-20px scaleX-n1-rtl text-muted"></i>
                                            </a>
                                        ...
                                        <li>
                                            <a href="help-center-article.html"
                                                class="text-heading d-flex justify-content-between align-items-center">
                                                <span class="text-truncate me-1"> Are RSS feeds available on Market?
                                                </span>
                                                <i
                                                    class="tf-icons ri-arrow-right-s-line ri-20px scaleX-n1-rtl text-muted"></i>
                                            </a>
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="row gy-6 gy-md-0">
                        <div class="col-md-4">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    <svg width="58" height="58" viewBox="0 0 58 58" fill="currentColor"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.2">
                                            <path
                                    ...
                                    <p class="mb-3">Expert tips and tools to improve your website or online store using
                                        our blog.</p>
                                    <a href="help-center-article.html" class="btn btn-outline-primary">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                                ...
                                <div class="card-body text-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="58" height="58"
                                        ...
                                        <path
                                            ...
                                            stroke="currentColor" stroke-opacity="1" stroke-width="2"
