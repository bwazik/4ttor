        ...
        <div class="container">
            <div class="swiper-logo-carousel pt-lg-4 mt-12">
                <div class="swiper" id="swiper-clients-logos">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/img/front-pages/branding/logo-1-light.png') }}" alt="client logo"
                        ...
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/img/front-pages/branding/logo-2-light.png') }}" alt="client logo"
                        ...
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/img/front-pages/branding/logo-3-light.png') }}" alt="client logo"
                        ...
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/img/front-pages/branding/logo-4-light.png') }}" alt="client logo"
                        ...
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/img/front-pages/branding/logo-5-light.png') }}" alt="client logo"
