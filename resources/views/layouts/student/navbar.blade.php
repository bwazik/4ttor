            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{ Auth::user()->profile_pic ? asset('storage/profiles/students/' . Auth::user()->profile_pic) : asset('assets/img/avatars/default.jpg') }}" alt="avatar" class="rounded-circle" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('student.account.personal.edit') }}">
